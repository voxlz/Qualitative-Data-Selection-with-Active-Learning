# CODE ORIGINALLY FROM https://github.com/keras-team/keras/blob/e6784e4302c7b8cd116b74a784f4b78d60e83c26/keras/applications/vgg16.py

"""VGG16 model for Keras.

Same (copied) code as in tf except for the following:
- One of the pooling layers did not have padding "same" so I added it.
...
def VGG16(
    ...
    x = layers.MaxPooling2D((2, 2), strides=(2, 2), padding="same", name="block5_pool")(x)
    ...
    model.compile(
        ...
        metrics=[tf.keras.metrics.SparseTopKCategoricalAccuracy(k=1, name="top_1_acc"),
                 tf.keras.metrics.SparseTopKCategoricalAccuracy(k=5, name="top_5_acc"),
                 tf.keras.metrics.SparseTopKCategoricalAccuracy(k=20, name="top_20_acc")])
