# Taken from https://github.com/google/automl/blob/ea9d3c58f48f8e99bad0119a7b3a1ad5953481e0/efficientdet/keras/train_lib.py#L854
...
def get_optimizer(params):
  ...
  precision = docker_utils.get_precision(params['strategy'], params['mixed_precision'])
...
class EfficientDetNetTrain(efficientdet_keras.EfficientDetNet):
  ...
  def _detection_loss(self, cls_outputs, box_outputs, labels, loss_vals):
    ...
    if positives_momentum > 0:
      ...
      num_positives_sum = docker_utils.cross_replica_mean(num_positives_sum)
